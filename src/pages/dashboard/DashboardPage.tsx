...
function SkeletonChart() {
  return (
    <div style={{ width: '100%', padding: '16px', background: '#fff', borderRadius: '16px', boxShadow: '1px 6px 3px rgba(128,128,128,0.287)' }}>
...
function SkeletonAlerts() {
  return (
    <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '16px' }}>
      ...
      <div style={{ padding: '10px', borderRadius: '8px', border: '1px solid #f1f5f9', marginBottom: '8px' }}>
      ...
      <div style={{ padding: '10px', borderRadius: '8px', border: '1px solid #f1f5f9' }}>
        <div style={{ display: 'flex', gap: '8px' }}>
          <div style={{ ...skeletonPulse, width: '14px', height: '14px', flexShrink: 0 }} />
          <div style={{ flex: 1 }}>
            <div style={{ ...skeletonPulse, width: '100px', height: '10px', marginBottom: '4px' }} />
      ...
      {loading ? (
        <>
          ...
          <div style={{ width: '100%', display: 'grid', gridTemplateColumns: bp.lg ? '2fr 1fr' : '1fr', gap: '16px' }}>
            <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '16px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ width: '100%', display: 'grid', gridTemplateColumns: bp.lg ? '2fr 1fr' : '1fr', gap: '16px' }}>
            <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', width: '100%' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                ...
                {txns.length === 0 && <p style={{ fontSize: '12px', color: '#94a3b8' }}>No transactions yet</p>}
              </div>
            </div>
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', width: '100%', fontSize: '16px', lineHeight: '16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {alertList.length === 0 && <p style={{ fontSize: '12px', color: '#94a3b8' }}>No alerts</p>}
                </div>
              </div>
            </div>
          </div>
